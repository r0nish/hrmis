(function () {
    ...
    angular
        ...
        .controller('RouteListFilterController',RouteListFilterController);

    /* @ngInject */
    function RouteListFilterController($scope,BaseController,businessUnitService,TownService,VisitTypeService,VisitFrequencyService,VisitCategoryService,DeliveryTypeService, RouteDataShareService, $mdSidenav) {
        var vm = $scope;
        vm.data = [];
        vm.checked = true;
        vm.routes = [];
