(function () {
    ...
    function widget($mdTheming) {
        ...
        var directive = {
            restrict: 'E',
            templateUrl: 'app/foundation/components/simple-table-card/widget.tmpl.html',
            transclude: true,
            replace: true,
            scope: {
                title: '@',
    ...
    function Controller() {
        ...
        function resetSearch() {
            vm.refcontroller.query.searchKey = '';
            this.searchKeyWord(vm.refcontroller.query.searchKey);
            vm.refcontroller.searchShow = false;
        }
